# Stage 1 - 라이브러리를 사용해 HTML 문서를 수집해보자.
...
위에서 클래스에 대해 먼저 소개해드린 이유는 이런 오픈소스 라이브러리들이 **클래스** 형태로 제공되기 때문입니다.
따라서 여러분은 클래스와 함수가 제공하는 **"추상성"**에 의해(내부 구현 방식을 잘 몰라도 사용법만 익히면 사용할 수 있는 성질을 말합니다.) HTML 문서 요청, HTML 문서 탐색과 같은 복잡한 기능을 text.strip\(\)을 사용하듯 편하게 쓸 수 있습니다.
