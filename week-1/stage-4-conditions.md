...
두 데이터는 div.top\_main과 div\#content에서 처음 갈라져 많은 구분되는 조상들을 가지고 있지만 간결하게 구분될 만큼만 이용해주면 됩니다.
...
제목 : 'tooltip' 간결하고 정확합니다. tooltip 태그는 4위 ~ 100위 클립의 제목 외에 어느 곳에도 사용되지 않습니다.

채널명 : 'dd.chn &gt; a' 채널명을 내용으로 갖는 a 태그는 흔하게 쓰이는 하이퍼링크 태그이므로 채널명을 감싸는 데에만 쓰이는 dd.chn을 붙여줍니다.

조회수 : 'dd.meta &gt; span.hit' 앞에서 봤듯 span.hit은 1~3위 클립의 조회수에도 사용됩니다. 이와 겹치지 않기 위해 부모 선택자를 붙여줍니다.

좋아요 수 : 'dd.meta &gt; span.like' 마찬가지입니다.

이 네 개의 선택자 경로를 이용하면 원하는 단위 데이터를 모두 뽑아낼 수 있습니다.

제목 목록 = '한고은, 남편 신영수 만난 후', '작곡가 대만족, 국.슈', '결혼해줘서 고마워요', '새우구이 너무 고소해' 채널명 목록 = '동상이몽3', '프로듀스 49', '배트맨이 돌아왔다', '동상이몽3', '김만병의 머피의 법칙' 조회수 목록 = '168809', '765834', '639679', '143903', '659310' 좋아요 수 목록 = '1412', '15740', '5086', '715', '2753'
...
제목 : 'div.cds tooltip' 채널명 : 'div.cds dd.chn &gt; a' 조회수 : 'div.cds span.hit' 좋아요 수 : 'div.cds span.like'

조회수와 좋아요 수에 붙어있던 dd.meta는 더 이상 필요가 없습니다. div.cds는 4위 ~ 100위까지의 클립 정보만 포함되기 때문입니다.
